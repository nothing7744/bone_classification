...
def savaMhdPath(name,path0,path1,path2,path3,path4,path5,path6):
...
if __name__=='__main__':
    savaMhdPath(name1,path0_tr,path1_tr,path2_tr,path3_tr,path4_tr,path5_tr,path6_tr)
    savaMhdPath(name2,path0_val,path1_val,path2_val,path3_val,path4_val,path5_val,path6_val)
    savaMhdPath(name3,path0_tst,path1_tst,path2_tst,path3_tst,path4_tst,path5_tst,path6_tst)
