...
num_epochs =100
dirname='/home/kehao/bone_detection_classification_mhd/'
csvname1='./csv/box_train_mhd.csv'
csvname2='./csv/box_val_mhd.csv'
csvname3='./csv/box_test_mhd.csv'
#######################################
...
########################################
train_set=MyDatasets(dirname,csvname1,True)
val_set=MyDatasets(dirname,csvname2,False)
test_set=MyDatasets(dirname,csvname3,False)
########################################
batch=16
...
start_epoch=0
if RESUME:
    path_checkpoint = "/data/kehao/models/checkpoint/ckpt_best_48.pth"  
...
def train():
    ...
    # time_list = []
    print("===================train start=====================")
    fw = open("/home/kehao/bone_detection_classification_mhd/logs/trlog.txt", 'w')
